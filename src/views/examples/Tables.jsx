            ...
            <div className="col">
              <Card className="bg-default shadow">
                <CardHeader className="bg-transparent border-0">
                  <h3 className="text-white mb-0">Chat Room</h3>
                </CardHeader>
                <Table
                      ...
                      <th scope="row">
                        <Media className="align-items-center">
                          ...
                          >
                            <img
                              alt="..."
                              src={require("assets/img/theme/ambassador.png")}
                            />
                          </a>
                          <Media>
                      ...
                      <th scope="row">
                        <Media className="align-items-center">
                          ...
                          >
                            <img
                              alt="..."
                              src={require("assets/img/theme/platinum.png")}
                            />
                          </a>
                          <Media>
                            {/* <span className="mb-0 text-sm">
                      ...
                      <th scope="row">
                        <Media className="align-items-center">
                          ...
                          >
                            <img
                              alt="..."
                              src={require("assets/img/theme/gold.png")}
                            />
                          </a>
                          <Media>
                            {/* <span className="mb-0 text-sm">
                      ...
                      <th scope="row">
                        <Media className="align-items-center">
                          ...
                          >
                            <img
                              alt="..."
                              src={require("assets/img/theme/silver.png")}
                            />
                          </a>
                          <Media>
                            {/* <span className="mb-0 text-sm">
                      ...
                      <th scope="row">
                        <Media className="align-items-center">
                          ...
                          >
                            <img
                              alt="..."
                              src={require("assets/img/theme/member.png")}
                            />
                          </a>
                          <Media>
                            {/* <span className="mb-0 text-sm">
